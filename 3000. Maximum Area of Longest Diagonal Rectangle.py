def areaOfMaxDiagonal():
    ...
    for r in range(len(dimensions)):
        if max_area < dimensions[r][0] ** 2 + dimensions[r][1] ** 2:
            length = dimensions[r][0]
            width = dimensions[r][1]

            max_area = dimensions[r][0] ** 2 + dimensions[r][1] ** 2
            
        elif max_area == dimensions[r][0] ** 2 + dimensions[r][1] ** 2:
            if length * width < dimensions[r][0] * dimensions[r][1]:
               length = dimensions[r][0]
               width = dimensions[r][1]
               max_area = dimensions[r][0] ** 2 + dimensions[r][1] ** 2
